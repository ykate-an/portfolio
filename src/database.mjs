const works = [
  {
    ...
    projects: [
      {
        title: "WORK_SDSE_PROJECT_01_TITLE",
        period: "WORK_SDSE_PROJECT_01_PERIOD",
      ...
      {
        title: "WORK_SDSE_PROJECT_02_TITLE",
        period: "WORK_SDSE_PROJECT_02_PERIOD",
  ...
  },
  {
    ...
    projects: [
      {
        title: "WORK_CB_PROJECT_01_TITLE",
        period: "WORK_CB_PROJECT_01_PERIOD",
      ...
      {
        title: "WORK_CB_PROJECT_02_TITLE",
        period: "WORK_CB_PROJECT_02_PERIOD",
